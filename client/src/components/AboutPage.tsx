    ...
    <div className="about-page">
          ...
          <Card className="border-0 shadow-sm">
            <Card.Body>
              <blockquote className="blockquote mb-0">
                <p><FaQuoteLeft className="me-2 text-primary" />
      ...
      <Row className="mb-5">
        <Col lg={10} className="mx-auto text-center">
          ...
          <p className="lead mb-4">
            Help us build a more informed and empowered student body. Share your experiences,
            discover great tutors, and make the most of the university's academic opportunities with TuteReview.
          </p>
          <CTAButtons primaryVariant="primary" secondaryVariant="outline-primary" singleButtonAlignment="center"
          />
        </Col>
      </Row>
      ...
      <Row className="mb-5">
        <Col lg={8} className="mx-auto">
          ...
          <p>
            With so many potential combinations of subject, college, and paper, it often isn't possible to ask
            someone you know how they found the module that you're considering. This is where TuteReview comes in.
          </p>
        </Col>
      </Row>
      ...
      <Row className="mb-5">
        <Col lg={8} className="mx-auto">
          ...
          <p>
            The questions we ask are there so that others can know what to expect from selecting a particular module,
      ...
      <Row className="mb-5">
        <Col lg={8} className="mx-auto">
          ...
          <p>
            ...
            flexibility around tutors/supervisors than you might imagine.
            <InfoPopover content={
              <span>
                For instance, see the first full paragraph on{' '}
                <a href="https://www.ppe.ox.ac.uk/sitefiles/ppe-handbook-prelims-2023-24-final-1.0.pdf#page=11" 
                   target="_blank" 
                   rel="noreferrer"
          ...
          <p>
            Given the absence of information about what different papers and tutors/supervisors would be like,
            this choice is pretty meaningless, though. We think that can and should change, and we hope you join us on the mission.
          </p>
        </Col>
      </Row>
